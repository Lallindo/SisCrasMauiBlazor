...
-- TABELA PRONTUARIOS (Com Correção de FormaDeAcesso para INT e correção de TecnicoId)
-- Prontuarios são criados com o CRAS e o Técnico atuais (cache)
INSERT INTO Prontuarios(Codigo, CrasId, FamiliaId, FormaDeAcesso, TecnicoId)
VALUES (1, 1, 1, 1, 1),   -- P1: Cras Central(1), Tec Bruno(1), FormaAcesso Espontanea(1)
       (2, 2, 2, 2, 2),   -- P2: Cras Dona Tita(2), Tec José(2), FormaAcesso BuscaAtiva(2)
       (3, 3, 3, 1, 3),   -- P3: Cras Pedro Ometto(3), Tec Amanda(3), FormaAcesso Espontanea(1)
       (4, 5, 4, 2, 4),   -- P4: Cras Altos da Cidade(5), Tec Roberto(4), FormaAcesso BuscaAtiva(2)
       (5, 1, 5, 5, 1),   -- P5: Cras Central(1), Tec Bruno(1), FormaAcesso EncaminhamentoSaude(5)
       (6, 2, 6, 1, 2),   -- P6: Cras Dona Tita(2), Tec José(2), FormaAcesso Espontanea(1)
       (7, 4, 7, 8, 1);   -- P7: Cras Cila de Bauab(4), Tec Bruno(1), FormaAcesso EncaminhamentoTutelar(8)

-- TABELA PRONTUARIOCRAS (NOVO)
-- Cria o primeiro vínculo ativo (DataSaida = NULL) para cada prontuário.
-- Assume que os IDs dos Prontuarios são sequenciais de 1 a 7, correspondendo à ordem de inserção.
INSERT INTO ProntuarioCras (ProntuarioId, CrasId, DataEntrada, DataSaida, TecnicoResponsavelId, FormaDeAcesso)
VALUES (1, 1, '03-11-2025', NULL, 1, 1),
       (2, 2, '04-10-2025', NULL, 2, 2),
       (3, 3, '12-09-2025', NULL, 3, 1),
       (4, 5, '12-10-2025', NULL, 4, 2),
       (5, 1, '12-11-2025', NULL, 1, 5),
       (6, 2, '12-12-2025', NULL, 2, 1),
       (7, 4, '12-12-2025', NULL, 1, 8);
