...
public class FamiliaRepositoryTests : BaseRepositoriesTests
{
    ...
    public async Task GetActiveUsuariosFromFamilia_ShouldReturnOnlyActiveUsuarios()
    {
        ...
        var familiaUsuarioInativo = ModelFactory.CreateFamiliaUsuario(familia.Id, usuarioInativo.Id,
            dataSaida: DateOnly.FromDateTime(DateTime.Now));
    ...
    public async Task GetResponsavelFromFamilia_ShouldReturnNullWhenResponsavelInactive()
    {
        ...
        var familiaUsuario = ModelFactory.CreateFamiliaUsuario(
            familia.Id, responsavel.Id, ParentescoEnum.Responsavel, DateOnly.FromDateTime(DateTime.Now)); // Inactive
        _context.FamiliaUsuarios.Add(familiaUsuario);
        await _context.SaveChangesAsync();
