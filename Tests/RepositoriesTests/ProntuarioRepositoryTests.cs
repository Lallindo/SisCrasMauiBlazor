...
{
    private ProntuarioRepository _repository;

    public override async Task InitializeAsync()
    {
        await base.InitializeAsync();
        _repository = new ProntuarioRepository(_context);
    ...
    public async Task AddAsync_ShouldAddProntuario()
    {
        ...
        var prontuario =
            ModelFactory.CreateProntuario(cras.Id, familia.Id, tecnico.Id, 1001, FormaAcessoEnum.BuscaAtiva);
        ...
        Assert.Equal(FormaAcessoEnum.BuscaAtiva, result.FormaDeAcesso);
    ...
    public async Task UpdateAsync_ShouldUpdateProntuario()
    {
        ...
        prontuario.FormaDeAcesso = FormaAcessoEnum.BuscaAtiva;
        ...
        Assert.Equal(FormaAcessoEnum.BuscaAtiva, updatedProntuario.FormaDeAcesso);
    }
