...
public class TecnicoServiceTests
{
    ...
    public async Task AddAsync_ShouldCallRepository()
    {
        ...
        _mockTecnicoRepository.Verify(r => r.AddAsync(tecnico, new CancellationToken()), Times.Once);
    }
    ...
    public async Task GetByIdAsync_ShouldCallRepository()
    {
        ...
        // Assert
        Assert.Equal(tecnico, result);
        _mockTecnicoRepository.Verify(r => r.GetByIdAsync(1, new CancellationToken()), Times.Once);
    }
    ...
    public async Task GetAllAsync_ShouldCallRepository()
    {
        ...
        {
            new() { Id = 1, Nome = "Tecnico 1", Login = "tec1" },
            new() { Id = 2, Nome = "Tecnico 2", Login = "tec2" }
        };
        ...
        _mockTecnicoRepository.Verify(r => r.GetAllAsync(new CancellationToken()), Times.Once);
    }
    ...
    public async Task UpdateAsync_ShouldCallRepository()
    {
        ...
        // Assert
        _mockTecnicoRepository.Verify(r => r.UpdateAsync(tecnico, new CancellationToken()), Times.Once);
    }
    ...
    public async Task DeleteAsync_ShouldCallRepository()
    {
        ...
        // Assert
        _mockTecnicoRepository.Verify(r => r.DeleteAsync(tecnico, new CancellationToken()), Times.Once);
    }
}
