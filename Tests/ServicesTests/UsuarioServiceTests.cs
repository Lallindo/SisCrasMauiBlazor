...
public class UsuarioServiceTests
{
    ...
    public async Task AddAsync_ShouldCallRepository()
    {
        ...
        _mockRepository.Verify(r => r.AddAsync(usuario, new CancellationToken()), Times.Once);
    }
    ...
    public async Task GetAllAsync_ShouldCallRepository()
    {
        ...
        {
            new() { Id = 1, Nome = "Usuario 1", Cpf = "11111111111" },
            new() { Id = 2, Nome = "Usuario 2", Cpf = "22222222222" }
        };
    ...
    public async Task UpdateAsync_ShouldCallRepository()
    {
        ...
        // Assert
        _mockRepository.Verify(r => r.UpdateAsync(usuario, new CancellationToken()), Times.Once);
    }
    ...
    public async Task DeleteAsync_ShouldCallRepository()
    {
        ...
        // Assert
        _mockRepository.Verify(r => r.DeleteAsync(usuario, new CancellationToken()), Times.Once);
    }
