...
public class CrasServiceTests
{
    ...
    public async Task AddAsync_ShouldCallRepository()
    {
        ...
        _mockRepository.Setup(r => r.AddAsync(cras, new CancellationToken()))
        ...
        _mockRepository.Verify(r => r.AddAsync(cras, new CancellationToken()), Times.Once);
    }
    ...
    public async Task GetByIdAsync_ShouldCallRepository()
    {
        ...
        _mockRepository.Setup(r => r.GetByIdAsync(1, new CancellationToken()))
    ...
    public async Task GetAllAsync_ShouldCallRepository()
    {
        ...
        {
            new() { Id = 1, Nome = "CRAS 1" },
            new() { Id = 2, Nome = "CRAS 2" }
        };
        _mockRepository.Setup(r => r.GetAllAsync(new CancellationToken()))
    ...
    public async Task UpdateAsync_ShouldCallRepository()
    {
        ...
        _mockRepository.Setup(r => r.UpdateAsync(cras, new CancellationToken()))
        ...
        // Assert
        _mockRepository.Verify(r => r.UpdateAsync(cras, new CancellationToken()), Times.Once);
    }
    ...
    public async Task DeleteAsync_ShouldCallRepository()
    {
        ...
        _mockRepository.Setup(r => r.DeleteAsync(cras, new CancellationToken()))
            .Returns(Task.CompletedTask);
        ...
        // Assert
        _mockRepository.Verify(r => r.DeleteAsync(cras, new CancellationToken()), Times.Once);
    }
