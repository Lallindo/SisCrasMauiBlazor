...
public class FamiliaServiceTests
{
    ...
    public async Task AddAsync_ShouldCallRepository()
    {
        ...
        _mockRepository.Verify(r => r.AddAsync(familia, new CancellationToken()), Times.Once);
    }
    ...
    public async Task GetAllAsync_ShouldCallRepository()
    {
        ...
        {
            new() { Id = 1, ConfiguracaoFamiliar = ConfiguracaoFamiliarEnum.FamiliaNuclear },
            new() { Id = 2, ConfiguracaoFamiliar = ConfiguracaoFamiliarEnum.MonoparentalFeminina }
        };
    ...
    public async Task UpdateAsync_ShouldCallRepository()
    {
        ...
        // Assert
        _mockRepository.Verify(r => r.UpdateAsync(familia, new CancellationToken()), Times.Once);
    }
    ...
    public async Task DeleteAsync_ShouldCallRepository()
    {
        ...
        // Assert
        _mockRepository.Verify(r => r.DeleteAsync(familia, new CancellationToken()), Times.Once);
    }
