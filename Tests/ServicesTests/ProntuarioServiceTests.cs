...
public class ProntuarioServiceTests
{
    ...
    public async Task AddAsync_ShouldCallRepository()
    {
        ...
        var prontuario = new Prontuario
        {
            ...
            FormaDeAcesso = FormaAcessoEnum.Espontanea
        };
        ...
        _mockRepository.Verify(r => r.AddAsync(prontuario, new CancellationToken()), Times.Once);
    }
    ...
    public async Task GetByIdAsync_ShouldCallRepository()
    {
        ...
        // Assert
        Assert.Equal(prontuario, result);
        _mockRepository.Verify(r => r.GetByIdAsync(1, new CancellationToken()), Times.Once);
    }
    ...
    public async Task GetAllAsync_ShouldCallRepository()
    {
        ...
        {
            new() { Id = 1, Codigo = 1001, DataCriacao = DateOnly.FromDateTime(DateTime.Now) },
            new() { Id = 2, Codigo = 1002, DataCriacao = DateOnly.FromDateTime(DateTime.Now) },
            new() { Id = 3, Codigo = 1003, DataCriacao = DateOnly.FromDateTime(DateTime.Now) }
        };
        ...
        _mockRepository.Verify(r => r.GetAllAsync(new CancellationToken()), Times.Once);
    }
    ...
    public async Task UpdateAsync_ShouldCallRepository()
    {
        ...
        var prontuario = new Prontuario
        {
            Id = 1,
            Codigo = 1001,
            FormaDeAcesso = FormaAcessoEnum.BuscaAtiva
        };
        ...
        // Assert
        _mockRepository.Verify(r => r.UpdateAsync(prontuario, new CancellationToken()), Times.Once);
    }
    ...
    public async Task DeleteAsync_ShouldCallRepository()
    {
        ...
        // Assert
        _mockRepository.Verify(r => r.DeleteAsync(prontuario, new CancellationToken()), Times.Once);
    }
    ...
    public async Task GetFamiliaAndUsuariosFromProntuario_ShouldCallRepository()
    {
        ...
        var prontuario = new Prontuario
        {
            ...
            Familia = new Familia
            {
                ...
                {
                    new() { Usuario = new Usuario { Id = 1, Nome = "Usuario 1" } }
                }
            }
        };
    ...
    public async Task GetFamiliaAndUsuariosFromProntuario_ById_ShouldCallRepository()
    {
        ...
        var prontuario = new Prontuario
        {
            ...
            Familia = new Familia
            {
                ...
                {
                    new() { Usuario = new Usuario { Id = 1, Nome = "Usuario 1" } },
                    new() { Usuario = new Usuario { Id = 2, Nome = "Usuario 2" } }
                }
            }
        };
    ...
    public async Task GetByIdAsync_ShouldReturnNullForNonExistentProntuario()
    {
        ...
        // Assert
        Assert.Null(result);
        _mockRepository.Verify(r => r.GetByIdAsync(999, new CancellationToken()), Times.Once);
    }
}